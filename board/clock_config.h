...
#define BOARD_BOOTCLOCKFRO18M_SYSTEM_CLOCK            9000000UL      /* Clock consumers of System_clock output : ACOMP, ADC, CAPT, CRC, CTIMER0, DAC0, GPIO, I2C0, I2C1, IOCON, MRT0, PINT, PLU, SPI0, SWM0, USART0, USART1, WKT, WWDT */
